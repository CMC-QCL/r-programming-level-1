...
(Possible) Digital Badge Requirement: all hands-on exercise to be submitted to qcl@cmc.edu with its subject being  
__"QCL Workshop Hands-On - [YOUR_NAME] on [DATE]"__
...
QCL Workshop Hands-On - [Your Name] on [Date] 
...
Follow the instructor and import "Births2015.csv" file!
...
(1) Import "auto.csv" as *auto*  
(2) Output the first row of *auto* using R's built-in function  
(3) Output the last row of *auto* using R's built-in function
...
Exercise 3:
In this exercise, you want to create a scatter plot showing mpg on X-axis (horizontal axis) and horsepower on Y-axis (vertical axis) to see the relationship between the two variables.
...
(4) Send the R Notebook file to qcl@cmc.edu (subject line: "QCL Workshop Hands-On - [Your Name] on [DATE]") as an attachment.
