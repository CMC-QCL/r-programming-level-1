...
```
Error in knitr::include_graphics("r-programming-beginner-figure/Data_Wrangling_with_R.png") : 
  Cannot find the file(s): "r-programming-beginner-figure/Data_Wrangling_with_R.png"
```
